          ...
          const runAutonomyCycle = async () => {
            ...
            try {
              ...
              const briefing = [
                ...
                "- Do NOT buy a market you already own — diversify into different markets each cycle",
                ...
                "- If you have cash and see a good market you DON'T already own, BUY it",
                "- If a position is down >30%, sell it. If up >50%, take profit",
                "- If nothing looks good, just say HOLD",
                "- VARY your picks — don't always choose the same market",
                "",
